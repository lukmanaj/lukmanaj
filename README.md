...
* 🧠  I am currently enrolled in Johns Hopkins University's `Genomic Data Science Specialization` on `Coursera` and `Applied Statistics in Python` track on `DataCamp`
* 🤝  I am open to collaborating on interesting projects
* 📝  I began writing on [medium](https://lukmanaj.medium.com/), now I maintain a quarto [blog](https://lukmanaj.github.io/ailearningloop/), where I post contents like:
