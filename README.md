...
* 🧠  I am currently enrolled in Johns Hopkins University's `Health Informatics Specialization`  and University of Illinois Urbana-Champaign's `Deep Learning for Healthcare Specialization` on `Coursera`.
