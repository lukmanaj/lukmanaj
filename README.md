...
* 🧠  I am currently enrolled in Johns Hopkins University's `Drug Development and Pharmacoepidemiology` on `Coursera` and `Power BI Fundamentals` track on `DataCamp`
