...
* 🧠  I am currently enrolled in Johns Hopkins University's `Genomic Data Science Specialization` on `Coursera` and `Associate AI Engineer for Developers` track on `DataCamp`
