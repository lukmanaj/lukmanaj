...
* 🧠  I'm currently learning `Foundation of Data Structures and Algorithms Specialization` on `Coursera` and I am also currently enrolled in Arewa Data Science Academy's `Deep Learning with PyTorch fellowship`
