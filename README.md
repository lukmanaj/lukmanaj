...
* 🧠  I am currently enrolled in Johns Hopkins University's `Genomic Data Science Specialization` on `Coursera` and `Developing Applications with LangChain` track on `DataCamp`
